...
window.mobileAndTabletCheck = function esOrdenador() {
    const agenteUsuario = navigator.userAgent;

    // Lista de palabras clave comunes en agentes de usuario de dispositivos móviles
    const dispositivosMoviles = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i;

    // Devuelve true si no se encuentra ninguna palabra clave de dispositivo móvil, lo que implica que es un ordenador
